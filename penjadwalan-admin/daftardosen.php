<?php
	...
	$sql = 	"SELECT nama_lengkap AS `Nama Dosen`, WA AS `No Telp`, email AS `Email`, id AS `id`
			FROM user
			WHERE role = 'dosen';";
...
<div class="wrapper">
	 ...
	 <div id="sidebar">
		...
		<ul class="list-unstyled component m-0">
          ...
          <li class="active">
		  	<a href="daftardosen.html" class="dashboard"><i class="material-icons">person</i>Daftar Dosen </a>
		  </li>
		  ...
		  <div class="top-navbar">
		     <div class="xd-topbar">
				 ...
				 <div class="xp-breadcrumbbar text-center">
				    <h4 class="page-title mt-2">Daftar Dosen</h4>
				 </div>
			 </div>
		  </div>
		  <!------top-navbar-end-----------> 
			...
			<div class="row">
				<div class="col-md-12">
					<div class="table-wrapper">		
						...
						<div class="clearfix">
						<div class="hint-text">showing <b><?php echo $count; ?></b> out of <b><?php echo $count; ?></b></div>
							<ul class="pagination">
       ...
       $(document).ready(function(){
		...
		// Save button click event
			...
			$(document).on("click", ".delete", function() {
				...
				$.ajax({
					url: "delete_dosen.php", // Replace with the URL of your server-side script to delete the data
					type: "POST",
					data: { id: id },
					success: function(response) {
						console.log(response); // You can handle the response from the server here
