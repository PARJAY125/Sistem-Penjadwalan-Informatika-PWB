                ...
                <div class="card-body p-5 text-center">
                  ...
                  <div class="mb-md-5 mt-md-4 pb-5">
                    ...
                    <?php if (!empty($_GET['error'])){
                        $error = $_GET['error'];
                        echo '<label class="form-label">'.$error.'</label></div>';
                     }?>
                  ...
                  <div>
                    <p class="mb-0 " style="margin-top: -70px;">atau daftar sebagai? <a href="./registrasi_dosen.html" class="text-white-50 fw-bold"> Dosen</a>
                    </p>
                  </div>
